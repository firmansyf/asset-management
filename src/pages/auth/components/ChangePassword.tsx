import {changePasswordExpiry} from '@api/AuthCRUD'
import {configClass, errorValidation, KTSVG, toAbsoluteUrl} from '@helpers'
        ...
        changePasswordExpiry(params)
          ...
          .catch((e: any) => {
            ...
            Object.values(errorValidation(e)).map((message: any) =>
              setStatus(currentPasswortMsg || message)
            )
          })
      }, 1000)
    },
          ...
          <form className='form w-100' onSubmit={formik.handleSubmit} noValidate id='form-auth'>
            ...
            <div className='fv-row mb-10'>
              ...
              <div className='pass-wrapper'>
                ...
                />
                <i className='visible' onClick={togglePassword}>
                  {passwordShown && (
                    <KTSVG
            ...
            <div className='fv-row mb-10'>
              ...
              <div className='pass-wrapper'>
                ...
                />
                <i className='visible' onClick={toggleRepeatPassword}>
                  {repeatPasswordShown && (
                    <KTSVG
                      path={'/media/icons/duotone/General/eye-open-light.svg'}
                      className={'svg-icon svg-icon-2x svg-icon-primary'}
