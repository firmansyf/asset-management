...
import {getSetupColumnUser, saveSetupColumnUser} from '@api/UserCRUD'
...
const SetupColumnUser: FC<any> = () => {
  ...
  const saveColumns = () => {
    ...
    saveSetupColumnUser({columns: {fields}})
    ...
    <>
      ...
      <div className='card card-custom'>
        <div className='card-footer text-end'>
          <Link to='/user-management/users' className='btn btn-sm btn-secondary me-2'>
            {' '}
            Cancel{' '}
          </Link>
...
export default SetupColumnUser
