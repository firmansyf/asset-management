...
import {submitUndoGR} from '../Service'

let ModalUndoGR: FC<any> = ({showModal, setShowModal, setReload, reload, id}) => {
        ...
        {() => (
          <Form className='justify-content-center' noValidate>
            ...
            <Modal.Body>
              <div className=''>
                {intl.formatMessage({
                  id: 'ARE_YOU_SURE_YOU_WANT_TO_CHANGE_GR_STATUS_OF_THIS_INSURANCE_CLAIM_TO_INCOMPLETE',
                })}
              </div>
            </Modal.Body>
            <Modal.Footer>
