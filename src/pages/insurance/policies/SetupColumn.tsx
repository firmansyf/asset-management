...
import {getSetupColumnInsurancePolice, saveSetupColumnsInsurancePolice} from './Service'

const InsurancePolicyColumns: FC<any> = () => {
  const intl = useIntl()
  ...
  const handleSubmit = () => {
    ...
    saveSetupColumnsInsurancePolice({columns: {fields}})
    ...
    <>
      ...
      <div className='card card-custom'>
        <div className='card-footer text-end'>
          <Link to='/insurance/policies' className='btn btn-sm btn-secondary me-2'>
            Cancel
          </Link>
...
export default InsurancePolicyColumns
