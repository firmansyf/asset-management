...
import {deleteBulkMeter} from '../Service'

type BulkDeleteMeterProps = {
  showModal: any
  setShowModal: any
  setReloadMeter: any
  reloadMeter: any
...
const BulkDeleteMeter: FC<BulkDeleteMeterProps> = ({
  showModal,
  setShowModal,
  setReloadMeter,
  reloadMeter,
  ...
  const onSubmit = () => {
    ...
    if (dataChecked?.length > 0) {
      deleteBulkMeter({guids: dataChecked})
        .then((res: any) => {
      ...
      >
        {() => (
          <Form className='justify-content-center' noValidate>
            <Modal.Header>
              <Modal.Title>Bulk Delete Meter</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <div className=''>
...
export default BulkDeleteMeter
