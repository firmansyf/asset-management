...
import {deleteBulkPreventive} from '../Service'

type BulkDeletePreventiveProps = {
  showModal: any
  setShowModal: any
...
const BulkDeletePreventive: FC<BulkDeletePreventiveProps> = ({
  showModal,
  setShowModal,
  setReloadPreventive,
  reloadPreventive,
      ...
      <Formik
        ...
        onSubmit={() => {
          ...
          if (dataChecked?.length > 0) {
            deleteBulkPreventive({guids: dataChecked})
              .then((res: any) => {
      ...
      >
        {() => (
          <Form className='justify-content-center' noValidate>
            <Modal.Header>
              <Modal.Title>Bulk Delete Preventive</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <div className=''>
...
export default BulkDeletePreventive
