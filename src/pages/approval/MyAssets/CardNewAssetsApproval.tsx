...
const MyAssetsApproval: FC<any> = () => {
  ...
  const approvalNewAssetQuery: any = useQuery({
    // initialData: {data: []},
    queryKey: ['getNewAssetApproval', {page, limit, keyword, orderDir, orderCol, varFilterAll}],
    queryFn: async () => {
      const res: any = await getNewAssetApproval({
        page,
        limit,
        orderDir,
        orderCol,
  ...
  const dataApprovalNewAsset: any = approvalNewAssetQuery?.data || []
    ...
    <div className='card card-custom card-table'>
      <div className='card-table-header'>
        ...
        <FilterColumns
          ...
          api={getAssetNewApprovalOptColumns}
        />
      </div>
      ...
      <div className='card-body'>
        <DataTable
          ...
          onDetail={onDetail}
          edit={PermissionEdit}
          data={dataApprovalNewAsset}
          onChangePage={onPageChange}
          onChangeLimit={onChangeLimit}
          loading={!approvalNewAssetQuery?.isFetched}
          customEmptyTable='No New Asset Approval Added'
        />
      </div>
    </div>
  )
...
const CardNewAssetsApproval = memo(
  MyAssetsApproval,
  (prev: any, next: any) => JSON.stringify(prev) === JSON.stringify(next)
)
export {CardNewAssetsApproval}
