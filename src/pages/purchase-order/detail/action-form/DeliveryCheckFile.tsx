/* eslint-disable sonar/no-nested-assignment */
...
type DeliveryCheckFileProps = {
  setFieldValue: any
  validation?: any
  files?: any
}

const DeliveryCheckFile: FC<DeliveryCheckFileProps> = ({setFieldValue, validation, files}) => {
