...
import CardCustomFieldEmployee from './CardCustomFieldEmployee'

let CustomFieldEmployee: FC = () => {
  const intl = useIntl()
  ...
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>
        {intl.formatMessage({id: 'PAGETITLE.SETUP.CUSTOM_FIELDS.EMPLOYEE'})}
      </PageTitle>
      ...
      <Alert
        ...
        body={msg_alert}
        type={'delete'}
        title={'Delete Custom Field Employee'}
        confirmLabel={'Delete'}
        onConfirm={() => {
          confirmDeleteCF()
        }}
        ...
        <div className='modal-dialog modal-dialog-centered mw-900px'>
          <div className='modal-content'>
            <div className='modal-header'>
              <h2>Detail Custom Field Employee</h2>
...
CustomFieldEmployee = memo(
  CustomFieldEmployee,
  (prev: any, next: any) => JSON.stringify(prev) === JSON.stringify(next)
)
export default CustomFieldEmployee
