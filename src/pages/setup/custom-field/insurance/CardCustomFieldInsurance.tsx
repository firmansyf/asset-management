...
let CardCustomFieldInsurance: FC<any> = ({
  reloadData,
  setReloadData,
  checked,
  setChecked,
  ...
  const label: string = 'Custom Field Insurance'
  const section_type: string = 'insurance_policy'
  ...
  const params: any = {
    ...
    orderCol,
    keyword,
    filter: {section_type: 'insurance_policy'},
  }
  const CustomFieldsInsuranceQuery: any = useQuery({
    queryKey: ['getDataCFInsurance', {...params, reloadData}],
    queryFn: async () => {
  ...
  const dataCFInsurance: any = CustomFieldsInsuranceQuery?.data || []
    ...
    <>
      <div className='card card-custom card-table'>
        ...
        <div className='card-body'>
          <DataTable
            page={page}
            loading={!CustomFieldsInsuranceQuery?.isFetched}
            limit={limit}
            total={totalPage}
            data={dataCFInsurance}
            columns={columns}
            ...
            customEmptyTable={'No Insurance Policy Custom Field Added'}
          />
        </div>
      </div>
...
CardCustomFieldInsurance = memo(
  CardCustomFieldInsurance,
  (prev: any, next: any) => JSON.stringify(prev) === JSON.stringify(next)
)
export default CardCustomFieldInsurance
