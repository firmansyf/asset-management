...
let CardCustomFieldInventory: FC<any> = ({
  onDelete,
  setReloadData,
  reloadData,
  checked,
  ...
  const label: string = 'Custom Field Inventory'
  const section_type: string = 'inventory'
  ...
  const params: any = {
    ...
    orderCol,
    keyword,
    filter: {section_type: 'inventory'},
  }
  const CustomFieldsInventoryQuery: any = useQuery({
  ...
  const dataCFInventory: any = CustomFieldsInventoryQuery?.data || []
    ...
    <>
      <div className='card card-custom card-table'>
        ...
        <div className='card-body'>
          <DataTable
            page={page}
            loading={!CustomFieldsInventoryQuery?.isFetched}
            limit={limit}
            total={totalPage}
            data={dataCFInventory}
            columns={columns}
            ...
            customEmptyTable={'No Inventory Custom Field Added'}
          />
        </div>
      </div>
...
CardCustomFieldInventory = memo(
  CardCustomFieldInventory,
  (prev: any, next: any) => JSON.stringify(prev) === JSON.stringify(next)
)
export default CardCustomFieldInventory
