...
import CardCustomFieldInventory from './CardCustomFieldInventory'

let CustomFieldInventory: FC = () => {
  const intl = useIntl()
  ...
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>
        {intl.formatMessage({id: 'PAGETITLE.SETUP.CUSTOM_FIELDS.INVENTORY'})}
      </PageTitle>
      ...
      <Alert
        ...
        body={msg_alert}
        type={'delete'}
        title={'Delete Custom Field Location'}
        confirmLabel={'Delete'}
        onConfirm={() => {
          confirmDeleteCF()
        }}
...
CustomFieldInventory = memo(
  CustomFieldInventory,
  (prev: any, next: any) => JSON.stringify(prev) === JSON.stringify(next)
)
export default CustomFieldInventory
