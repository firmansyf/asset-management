...
import CardCustomFieldLocation from './CardCustomFieldLocation'

let CustomFieldLocation: FC = () => {
  const intl = useIntl()
  ...
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>
        {intl.formatMessage({id: 'PAGETITLE.SETUP.CUSTOM_FIELDS.LOCATION'})}
      </PageTitle>
