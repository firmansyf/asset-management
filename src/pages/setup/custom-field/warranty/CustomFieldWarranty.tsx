...
import CardCustomFieldWarranty from './CardCustomFieldWarranty'

let CustomFieldWarranty: FC = () => {
  const intl = useIntl()
  ...
  return (
    <>
      <PageTitle breadcrumbs={breadCrumbs}>
        {intl.formatMessage({id: 'PAGETITLE.SETUP.CUSTOM_FIELDS.WARRANTY'})}
      </PageTitle>
      ...
      <Alert
        ...
        body={msg_alert}
        type={'delete'}
        title={'Delete Custom Field Warranty'}
        confirmLabel={'Delete'}
        onConfirm={() => {
          confirmDeleteCF()
        }}
...
CustomFieldWarranty = memo(
  CustomFieldWarranty,
  (prev: any, next: any) => JSON.stringify(prev) === JSON.stringify(next)
)
export default CustomFieldWarranty
