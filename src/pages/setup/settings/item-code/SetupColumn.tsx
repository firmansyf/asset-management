...
import {getColumn, updateColumn} from '@pages/setup/settings/item-code/Service'
...
const CompanyColumns: FC<any> = () => {
  ...
  const saveColumns = () => {
    ...
    updateColumn({columns: {fields}})
      .then(({data: {message}}: any) => {
        navigate('/setup/settings/item-codes')
  ...
  useEffect(() => {
    redirect && navigate('/setup/settings/item-codes')
  }, [redirect])
