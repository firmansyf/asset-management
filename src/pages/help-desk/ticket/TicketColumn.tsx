...
import {getTicketColumn, updateTicketColumn} from './Service'

const TicketColumn: FC<any> = () => {
  const intl = useIntl()
  ...
  const saveColumns = () => {
    ...
    updateTicketColumn({columns: {fields}})
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>{intl.formatMessage({id: 'HELPDESK.TICKET.COLUMNS'})}</PageTitle>
      ...
      <div className='card card-custom'>
        <div className='card-footer text-end'>
          <Link to='/help-desk/ticket' className='btn btn-sm btn-secondary me-2'>
            Cancel
          </Link>
