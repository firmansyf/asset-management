...
class SearchComponent {
  ...
  private _getElement = (name: string) =>
    this?.element?.querySelector('[data-kt-search-element="' + name + '"]')
  ...
  private handlers(): void {
    ...
    if (this?.menuObject) {
      ...
      if (this?.toggleElement) {
        ...
        this?.menuObject?.on('kt?.menu?.dropdown?.show', function (this: any) {
          if (isVisibleElement(this?.toggleElement as any)) {
            this?.toggleElement?.classList?.add('active')
            this?.toggleElement?.classList?.add('show')
          }
        })

        this?.menuObject?.on('kt?.menu?.dropdown?.hide', function (this: any) {
      ...
      this?.menuObject?.on('kt?.menu?.dropdown?.shown', function (this: any) {
  ...
  public getQuery = () => this?.inputElement?.value

  public getMenu = () => this?.menuObject

  public getFormElement = () => this?.formElement
