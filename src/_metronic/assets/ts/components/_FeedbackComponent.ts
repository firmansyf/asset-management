...
class FeedbackComponent {
  ...
  public isShown = () => this.isShown

  public getElement = () => this.element

  // Event API
  public on = (name: string, handler: Function) => EventHandlerUtil.on(this.element, name, handler)

  public one = (name: string, handler: Function) =>
    EventHandlerUtil.one(this.element, name, handler)
