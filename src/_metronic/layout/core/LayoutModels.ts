...
type LayoutTypes = string | number | boolean
export interface ILayoutHTMLAttributes {
  asideMenu: Map<string, LayoutTypes>
  headerMobile: Map<string, LayoutTypes>
  headerMenu: Map<string, LayoutTypes>
  headerContainer: Map<string, LayoutTypes>
  pageTitle: Map<string, LayoutTypes>
}

export interface ILayoutCSSVariables {
  body: Map<string, LayoutTypes>
}
