...
describe('Report Department, Testing...', () => {
    beforeEach( () => { 
        cy.visit('reports/department')
      })

    it('Fetch Report Department', () => {
      ...
      it('Test Button Actions Automated Report', () => {
        ...
        cy.get('form').within(() => {
          ...
          cy.get('.modal-body').within(() => {
            cy.get('.report-name').find('input[name*="name"]').should('have.value', 'Departments')
